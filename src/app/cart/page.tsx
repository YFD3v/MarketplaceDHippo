    ...
    <div className="bg-white">
      <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="mt-12 lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-12 xl:gap-x-16">
                    ...
                    <li key={product.id} className="flex py-6 sm:py-10">
                      ...
                      <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                        ...
                        <p className="mt-4 flex space-x-2 text-sm text-gray-700">
                          ...
                          <span>Elegível para envio instantâneo</span>
                        </p>
                      </div>
                    </li>
                  );
          ...
          <section className="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:cols-span-5 lg:mt-0 lg:p-8">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                ...
                <div className="text-base font-medium text-gray-900">
                  {isMounted ? (
                    formatPrice(fee + cartTotalPrice)
                  ) : (
                    <Loader2 className="h-4 w-4 animate-spin text-muted-foreground" />
                  )}
                </div>
