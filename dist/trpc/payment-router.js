...
exports.paymentRouter = (0, trpc_1.router)({
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    //Adicionando a taxa de transação
                    //Esse price é do produto da taxa que eu criei pelo dashboard do stripe
                    line_items.push({
                        price: "price_1PNfIaJbY20Qi3DjrWPJpRyP",
                        quantity: 1,
                        adjustable_quantity: {
                            enabled: false,
                        },
    ...
    pullOrderStatus: trpc_1.privateProcedure.input(zod_1.z.object({ orderId: zod_1.z.string() })).query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
